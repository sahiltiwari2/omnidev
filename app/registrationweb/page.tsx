                            ...
                            <div className='flex items-start '>
                                <div className='flex flex-col md:flex-row gap-2'>
                                    <div className='flex flex-row gap-2'>
                                        ...
                                        <div className={Orbitronn.className}>
                                            <div className='text-[12px] mt-3 md:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-orange-500'>Web Development</div>
                                        </div>
                                    </div>
