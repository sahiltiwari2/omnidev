...
const cards = () => {
    return (
        <div className='flex gap-14 animate-slide-in-from-bottom'>
            <div className='w-[270px] h-[320px] border-2 border-blue-400 pt-5 rounded-lg shadow-md pl-5 hover:shadow-blue-300 transition duration-250'>
            ...
            <div className='w-[270px] h-[320px] border-2 border-yellow-400 pt-7 rounded-lg shadow-md pl-5 hover:shadow-yellow-300 transition duration-250'>
            ...
            <div className='w-[270px] h-[320px] border-2 border-purple-400 pt-5 rounded-lg shadow-md pl-5 hover:shadow-purple-300 transition duration-250'>
            ...
            <div className='w-[270px] h-[320px] border-2 border-orange-400 pt-5 rounded-lg shadow-md pl-5 hover:shadow-orange-300 transition duration-250'>
