...
const webCourses = () => {
    return (
        <div className=' flex justify-center'>
            <div className='mt-10  flex justify-center border-2 rounded-lg shadow-md p-9 max-w-6xl bg-gray-50 dark:bg-gray-900 hover:border-purple-600 transition hover:scale-110 animate-slide-in-from-left hover:shadow-purple-600 dark:hover:shadow-purple-600'>
